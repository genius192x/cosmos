...
<template>
  ...
  >
    <SheetContent
      ...
      data-mobile="true"
      :side="side"
      class="w-(--sidebar-width) dark:bg-background p-0 text-sidebar-foreground [&>button]:hidden"
      :style="{
  ...
  >
    ...
    <div
      :class="
        cn(
          'duration-200 relative h-svh w-(--sidebar-width) transition-[width] ease-linear bg-[#eff2f7] dark:bg-[#1a202c]',
